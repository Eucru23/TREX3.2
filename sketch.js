...
function setup() {
  ...
  ground = createSprite(width/2, height/2+50, width, 20);
  ...
  invisibleGround = createSprite(width/2, height/2+60, width, 10);
...
function spawnObstacles() {
  if (frameCount % 60 === 0) {
    var obstacle = createSprite(width, height/2+45, 10, 40);
